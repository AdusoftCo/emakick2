        ...
        <div>
            ...
            <div>
                ...
                <ul class="options-list ps-0">
                    <li><a class="nav-link option" href="galeria.php?option=femeninterior">DAMAS</a></li>
                    ...
                    <li><a class="nav-link option" href="galeria.php?option=camisonetas">CAMISON & CAMISETAS</a></li>
                </ul>
            </div>
        </div>
    </div>
