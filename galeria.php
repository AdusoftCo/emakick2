...
<?php
    if (isset($_GET['option'])) {
        ...
        if($_POST){  
            ...
            $sql = "INSERT INTO $opcion (`id`, `cod_art`, `id_prov`, `descripcion`, `costo`, `precio_doc`, `precio_oferta`, `fecha_alta`) 
    ...
    $opcion = $_SESSION['option'];

    $sql = "SELECT " . $opcion . ".id, " . $opcion . ".cod_art, " . $opcion . ".id_prov, " . $opcion . ".descripcion, " . $opcion . ".precio_doc, " . $opcion . ".precio_oferta, fabricants.nombre 
        FROM " . $opcion . "
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .fixed-section {
                ...
                left: 0;
                width: 100%;
                z-index: 150; /* Adjust the z-index as needed */
                background-color: #fff;
            }

            /* Adjust padding or margins for spacing as needed */
            .fixed-section .d-flex {
                padding: 10px;
            }
            .dropdown-container {
                ...
                <table class="table tabla__galeria" style="background-color:#FAFAFA;">
                    ...
                    <tbody >
                        ...
                        foreach($opData as $op){ ?>
                            <tr>
                                <td><?php echo $op['cod_art'];?></td>
                                <td><?php echo $op['nombre'];?></td>
                                <td><?php echo $op['descripcion'];?></td>
                                <td><?php echo $op['precio_doc'];?></td>
                                <td><?php echo $op['precio_oferta'];?></td>
                                <td><a name="modificar" id="modificar" class="btn btn-warning" href="?modificar=<?php echo $op['id']; ?>">Modificar</a></td>
                                <td><a onclick='wantdelete(event)' name="eliminar" id="eliminar" class="btn btn-danger" href="?borrar=<?php echo $op['id']; ?>">Borrar</a></td>
                            </tr>
                        ...
                        <div class="card border border-3 shadow w-100">
                            <div class="table-responsive">
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    <div>
                                        <a name="modificar" id="modificar" href="modificar.php?option=<?php echo $_GET['option']; ?>&modificar=<?php echo $op['id']; ?>"
                                                class="btn btn-warning">Modificar</a>
                                        <a onclick='wantdelete(event)' name="eliminar" id="eliminar" class="btn btn-danger" href="?borrar=<?php echo $op['id'];?>">Eliminar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
